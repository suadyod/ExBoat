...
.controller('MapCtrl', function($scope, $ionicLoading, $compile, $ionicModal,$ionicScrollDelegate, $location,$state) {
      ...
      function initialize() {
        ...
        var infoText1 = "<div><a ng-click='popopen1()'><br><h1>(N1){{ 'Oriental' | translate }}</h1></a></div>";
        ...
        var infoText0 = "<div><a ng-click='popopen0()'><br><h1>(CENTRAL){{ 'Sathorn' | translate }}</h1></a></div>";
        ...
        var infoText2 = "<div><a ng-click='popopen2()'><br><h1>(N2){{ 'Watmuangkae' | translate }}</h1></a></div>";
        ...
        var infoText3 = "<div><a ng-click='popopen3()'><br><h1>(N3){{ 'Siphraya' | translate }}</h1></a></div>";
        ...
        var infoText4 = "<div><a ng-click='popopen4()'><br><h1>(N4){{ 'Marinedept' | translate }}</h1></a></div>";
        ...
        var infoText5 = "<div><a ng-click='popopen5()'><br><h1>(N5){{ 'Rajchawongse' | translate }}</h1></a></div>";
        ...
        var infoText6 = "<div><a ng-click='popopen6()'><br><h1>(N6){{ 'Memorialbridge' | translate }}</h1></a></div>";
        ...
        var infoText7 = "<div><a ng-click='popopen7()'><br><h1>(N7){{ 'Rajinee' | translate }}</h1></a></div>";
        ...
        var infoText8 = "<div><a ng-click='popopen8()'><br><h1>(N8){{ 'Thatien' | translate }}</h1></a></div>";
        ...
        var infoText9 = "<div><a ng-click='popopen9()'><br><h1>(N9){{ 'Thachang' | translate }}</h1></a></div>";
        ...
        var infoText9s = "<div><a ng-click='popopen9s()'><br><h1>(N9s){{ 'Maharaj' | translate }}</h1></a></div>";
        ...
        var infoText10 = "<div><a ng-click='popopen10()'><br><h1>(N10){{ 'Wanglang' | translate }}</h1></a></div>";
        ...
        var infoText11 = "<div><a ng-click='popopen11()'><br><h1>(N11){{ 'Thonburirailway' | translate }}</h1></a></div>";
        ...
        var infoText12 = "<div><a ng-click='popopen12()'><br><h1>(N12){{ 'Phrapinklaobridge' | translate }}</h1></a></div>";
        ...
        var infoText13 = "<div><a ng-click='popopen13()'><br><h1>(N13){{ 'Phraarthit' | translate }}</h1></a></div>";
        ...
        var infoText14 = "<div><a ng-click='popopen14()'><br><h1>(N14){{ 'Rama8' | translate }}</h1></a></div>";
        ...
        var infoText15 = "<div><a ng-click='popopen15()'><br><h1>(N15){{ 'Thewej' | translate }}</h1></a></div>";
        ...
        var infoText16 = "<div><a ng-click='popopen16()'><br><h1>(N16){{ 'Krungthonburibridge' | translate }}</h1></a></div>";
        ...
        var infoText17 = "<div><a ng-click='popopen17()'><br><h1>(N17){{ 'Watthepnahree' | translate }}</h1></a></div>";
        ...
        var infoText18 = "<div><a ng-click='popopen18()'><br><h1>(N18){{ 'Payap' | translate }}</h1></a></div>";
        ...
        var infoText19 = "<div><a ng-click='popopen19()'><br><h1>(N19){{ 'Irrigationdept' | translate }}</h1></a></div>";
        ...
        var infoText20 = "<div><a ng-click='popopen20()'><br><h1>(N20){{ 'Kheawkhaika' | translate }}</h1></a></div>";
        ...
        var infoText21 = "<div><a ng-click='popopen21()'><br><h1>(N21){{ 'Kjakkai' | translate }}</h1></a></div>";
        ...
        var infoText22 = "<div><a ng-click='popopen22()'><br><h1>(N22){{ 'Bangpo' | translate }}</h1></a></div>";
        ...
        var infoText23 = "<div><a ng-click='popopen23()'><br><h1>(N23){{ 'Watsoithong' | translate }}</h1></a></div>";
        ...
        var infoText24 = "<div><a ng-click='popopen24()'><br><h1>(N24){{ 'Rama7' | translate }}</h1></a></div>";
        ...
        var infoText25 = "<div><a ng-click='popopen25()'><br><h1>(N25){{ 'Pibul1' | translate }}</h1></a></div>";
        ...
        var infoText26 = "<div><a ng-click='popopen26()'><br><h1>(N26){{ 'Watkhema' | translate }}</h1></a></div>";
        ...
        var infoText27 = "<div><a ng-click='popopen27()'><br><h1>(N27){{ 'Wattuek' | translate }}</h1></a></div>";
        ...
        var infoText28 = "<div><a ng-click='popopen28()'><br><h1>(N28){{ 'Watkien' | translate }}</h1></a></div>";
        ...
        var infoText29 = "<div><a ng-click='popopen29()'><br><h1>(N29){{ 'Pibul2' | translate }}</h1></a></div>";
        ...
        var infoText29s = "<div><a ng-click='popopen29s()'><br><h1>(N29s){{ 'Rama5' | translate }}</h1></a></div>";
        ...
        var infoText30 = "<div><a ng-click='popopen30()'><br><h1>(N30){{ 'Nonthaburi_Pibul3' | translate }}</h1></a></div>";
        ...
        var infoText31 = "<div><a ng-click='popopen31()'><br><h1>(N31){{ 'Ministryofcommerce' | translate }}</h1></a></div>";
        ...
        var infoText32 = "<div><a ng-click='popopen32()'><br><h1>(N32){{ 'Watklangkret' | translate }}</h1></a></div>";
        ...
        var infoText33 = "<div><a ng-click='popopen33()' ><br><h1>(N33){{ 'Pakkret' | translate }}</h1></a></div>";
        ...
        var infoTextT1 = "<div><a ng-click='popopenT1()'><br><h1>(S1){{ 'Watsawetachat' | translate }}</h1></a></div>";
        ...
        var infoTextT2 = "<div><a ng-click='popopenT2()'><br><h1>(S2){{ 'Watworachanyawas' | translate }}</h1></a></div>";
        ...
        var infoTextT3 = "<div><a ng-click='popopenT3()'><br><h1>(S3){{ 'Watrajsingkorn' | translate }}</h1></a></div>";
        ...
        var infoTextT4 = "<div><a ng-click='popopenT4()'><br><h1>(S4){{ 'Rajburana' | translate }}</h1></a></div>";
